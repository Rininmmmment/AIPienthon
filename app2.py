...
if reset and os.path.isfile("target_datasets/val2/imported_file.jpg"):
    os.remove("target_datasets/val2/imported_file.jpg")
else:
    pass
...
if uploaded_file:
 ...
 if not(os.path.isfile("target_datasets/val2/imported_file.jpg")):
...
if uploaded_file and kousin:
    ...
    image.save("target_datasets/val2/imported_file.jpg")
else:
    pass

if os.path.isfile("target_datasets/val2/imported_file.jpg"):
    #推論結果を格納
    val_dir2 = "target_datasets"
